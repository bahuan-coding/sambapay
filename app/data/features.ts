  ...
  groups: [
    {
      ...
      items: [
        ...
        { icon: 'pix', title: '', body: 'No Brasil, o pagamento instantâneo.' },
        ...
        { icon: 'qra', title: 'QR Argentina', body: 'Na Argentina, um código no caixa. Quem compra paga da carteira que já está no telefone.' },

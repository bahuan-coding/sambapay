...
export const esCopy = {
  ...
  columns: [
    ...
    },
    {
      ...
      items: [
        ...
        { mark: 'store', title: 'La tienda en línea', body: 'Digitalizamos la tienda donde tenemos estructura, del CNPJ a las entidades locales.' },
    ...
    },
    {
      ...
      items: [
        ...
        { mark: 'steps', title: 'Liquidación', body: 'El valor liquidado llega en el menor número de pasos.' },
  ...
  groups: [
    ...
    {
      title: 'Checkout',
      lede: 'Donde tenemos estructura, la tienda se levanta en este orden.',
      plate: 'enable',
      items: [
        { title: 'El stock', body: 'El negocio trae el stock. Un marketplace de nicho, o stock compartido entre tiendas físicas.' },
        { title: 'La tienda en línea', body: 'Digitalizamos la tienda donde tenemos estructura, del CNPJ a las entidades locales.' },
    ...
    },
    {
      ...
      items: [
        ...
        { title: 'El libro', body: 'El archivo del adquirente se concilia con el libro, línea por línea. Nada se paga antes de que el libro cierre.' },
        { title: 'Lo que sale', body: 'Tasas, reserva, reembolsos y chargebacks se descuentan antes de que el dinero se mueva.' },
        { title: 'Pocos pasos', body: 'El valor liquidado llega en el menor número de pasos.' },
...
export const esChapters = [
  ...
  },
  {
    ...
    title: 'Cómo se levanta la tienda',
    lede: 'Donde tenemos estructura, la tienda se levanta en este orden.',
    steps: [
      { title: 'El stock', body: 'El negocio trae el stock. Un marketplace de nicho, o stock compartido entre tiendas físicas.' },
      { title: 'La tienda en línea', body: 'Digitalizamos la tienda donde tenemos estructura, del CNPJ a las entidades locales.' },
